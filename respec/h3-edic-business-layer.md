...
To reach the EDICs' goals, these are the value propositions offered to the European LDT ecosystem.

### Target Customers and Partners
*   **Primary Customers:** Municipalities and local public administrations (the "Adopters").
*   **Key Partners:** Technology providers, research organizations, and National Nodes (the "Enablers").
